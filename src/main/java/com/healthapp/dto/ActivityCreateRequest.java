...
public class ActivityCreateRequest {
    ...
    private Activity.Visibility visibility = Activity.Visibility.PRIVATE;
    
    // Constructors
    public ActivityCreateRequest() {}
    
    public ActivityCreateRequest(String name, String category, java.math.BigDecimal caloriesPerMinute, Activity.Visibility visibility) {
        this.name = name;
