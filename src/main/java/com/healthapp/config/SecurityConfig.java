    ...
    public SecurityFilterChain filterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/steps/**", "/sleeps/**", "/moods/**", "/water/**", "/weights/**", "/food-entries/**", "/activity-entries/**", "/activities/**", "/activity-logs/**", "/ai/**", "/users/**").authenticated() // All health tracking and user management endpoints require authentication
